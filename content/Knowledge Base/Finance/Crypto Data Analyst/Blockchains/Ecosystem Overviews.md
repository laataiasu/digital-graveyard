...
- **Total Value Locked (TVL)**: This metric indicates the total value of assets secured within the Solana ecosystem, particularly in decentralized finance ([[Decentralized Finance|DeFi]]) applications.
...
- **Total Value Locked (TVL)**: Similar to other [[Decentralized Finance|DeFi]] ecosystems, TVL measures the total amount of assets locked in Optimism-based protocols.
